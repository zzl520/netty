 ...
 * the input {@link ByteBuf}, creates a new {@link ByteBuf} and forward it to the next {@link ChannelInboundHandler}
...
public abstract class ByteToMessageDecoder extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof ByteBuf) {
            try {
                ...
                decodeWasNull = context.numFireChannelReadCalled() == 0;
                context.reset();
            }
        } else {
    ...
    private void channelInputClosed(ByteToMessageDecoderContext ctx, boolean callChannelInactive) throws Exception {
        try {
